...
//android/src/android_webview/tools/system_webview_shell/apk/src/org/chromium/webview_shell/
...
public class WebViewBrowserActivity extends Activity implements PopupMenu.OnMenuItemClickListener {
	...
	//if (url.contains(",cg://")) {
	    ...
	    //String[] parts = url.split(",cg://");
	    //intent.setData(Uri.parse(parts[1]));
	    //intent.putExtra("webviewtime", parts[0]);
	    intent.setData(Uri.parse(url.substring(5)));
	    intent.setComponent(new ComponentName("lab.gtcsc.gchen.depot", "lab.gtcsc.gchen.depot.MainActivity"));   
	...
	Log.i("gchen36", "WebViewBrowserActivity getUrlFromIntent called!");
        return intent != null ? intent.getDataString() : null;
    }
    */
    private static String getUrlFromIntent(Intent intent) {
        return intent != null ? "cg://" + intent.getDataString() : null;
    }
